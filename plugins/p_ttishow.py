...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [[
            ...
            InlineKeyboardButton('📢 Updates', url='https://t.me/mrkpmovies')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
        ...
        for u in message.new_chat_members:
            if (temp.MELCOW).get('welcome') is not None:
                try:
                    ...
                    pass
            temp.MELCOW['welcome'] = await message.reply(f"<b>Hey , {u.mention}, We are Warmly Welcome to {message.chat.title} Just Type Your Movie Name</b>")
